...
### Fixed
- Timer drift when app loses focus in Cooking Mode

### Improved
- Recipe layout and collapsible ingredients panel

## [v0.2.0] - 2026-06-06

### Changed
- Migrated recipe schema to schema.org format

### Fixed
- Release pipeline: version now derived from git tags, removed direct push to main
